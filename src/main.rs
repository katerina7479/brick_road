...
fn main() {
    App::new()
        ...
        .insert_resource(blocks::DeleteUndoState::default())
        ...
        .add_systems(
            Update,
            blocks::handle_delete_undo.after(blocks::handle_block_delete),
        )
        .add_systems(
            Update,
        ...
        .add_systems(EguiPrimaryContextPass, blocks::draw_undo_toast)
